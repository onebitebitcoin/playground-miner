    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
      ...
      <div class="order-1">
        ...
        <div class="bg-white rounded-2xl shadow-lg border border-slate-200 p-6 mb-6">
          ...
          <div class="bg-orange-50 rounded-xl p-4 mb-4 border border-orange-100">
          ...
          <div class="bg-slate-50 border border-slate-200 rounded-xl p-6 mb-4 flex items-center justify-center">
            <MiningAnim :state="miningState" />
          </div>

          <!-- Mining Button -->
          <button
            class="w-full bg-slate-800 hover:bg-slate-700 disabled:bg-slate-400 text-white rounded-xl px-6 py-4 font-semibold text-lg transition-all duration-200 disabled:cursor-not-allowed"
    ...
    <div v-if="showBlocksModal" class="fixed inset-0 bg-black/50 flex items-center justify-center z-50 p-4">
      <div class="bg-white rounded-2xl shadow-2xl max-w-4xl w-full max-h-[90vh] flex flex-col">
        ...
        <div class="flex-1 overflow-y-auto p-6">
          <div v-if="broadcastMsg" class="mb-4 p-4 rounded-xl border border-orange-200 bg-orange-50 text-orange-700">
            {{ broadcastMsg }}
          </div>
