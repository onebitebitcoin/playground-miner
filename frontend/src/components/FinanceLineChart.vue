      ...
      <div class="bg-white rounded-2xl shadow-xl max-w-lg w-full max-h-[calc(100vh-3rem)] overflow-y-auto p-6 space-y-4">
        ...
        <div class="space-y-3 text-sm text-slate-700">
          ...
          <div class="space-y-3">
            ...
            <div class="bg-amber-50 rounded-xl border border-amber-200 p-4 space-y-2 text-xs font-mono text-amber-900">
              <p class="font-semibold text-amber-700">예금 · 적금</p>
              <p>매년 이자수익 × (1 - 15.4%) 만큼 재투자 (이자소득세 14% + 지방세 1.4%)</p>
