<template>
  <aside class="w-64 h-full pastel-sidebar border-r px-6 py-8 flex flex-col overflow-y-auto min-h-0">
  ...
  const icons = {
    home: () => h('svg', {
      ...
      h('path', {
        ...
        'stroke-width': '2',
        d: 'M3 9.5l9-7 9 7M5 10v9a2 2 0 002 2h3v-6h4v6h3a2 2 0 002-2v-9'
      })
    ]),
    learn: () => h('svg', {
      fill: 'none',
    ...
    compatibility: () => h('svg', {
      ...
      h('path', { 'stroke-linecap': 'round', 'stroke-linejoin': 'round', 'stroke-width': '2', d: 'M21 8.25c0-2.485-2.099-4.5-4.688-4.5-1.935 0-3.597 1.126-4.312 2.733-.715-1.607-2.377-2.733-4.313-2.733C5.1 3.75 3 5.765 3 8.25c0 7.22 9 12 9 12s9-4.78 9-12z' })
    ]),
