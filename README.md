...
## 학습 코스(Codecademy/CryptoZombies 스타일)

- 사이드바의 `코스` 메뉴를 통해 단계형 레슨을 진행할 수 있습니다.
- Mining 101: 실제 채굴 인터페이스를 옆에 두고, 블록 채굴/난이도/보상 변화를 미션으로 확인합니다.
- UTXO 101: UTXO 시뮬레이터와 함께 초기 UTXO 생성, 단일 수신자 전송, 잔돈(Change) 생성을 목표로 진행합니다.
- 각 단계는 브라우저 `localStorage`에 진행도가 저장됩니다.
